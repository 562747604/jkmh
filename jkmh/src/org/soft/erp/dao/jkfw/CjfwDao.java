...
public interface CjfwDao {

	// 动态插入
	@SelectProvider(type=CjfwDaoImpl.class,method="update")
	void update(Ryfp bean);
	
	// 动态查询
	@SelectProvider(type=CjfwDaoImpl.class,method="select")
	List<Ryfp> select(Map<String, Object> params);

	// 根据参数查询用户总数
	@SelectProvider(type=CjfwDaoImpl.class,method="count")
	Integer count(Map<String, Object> params);
	
	// 动态插入
	@SelectProvider(type=CjfwDaoImpl.class,method="addFc")
	void addFc(String id,String zjid,String zjname,Result rs);
	
	// 动态插入
	@SelectProvider(type=CjfwDaoImpl.class,method="updateFwzt")
	void updateFwzt(String id);
	
	// 动态插入
	@SelectProvider(type=CjfwDaoImpl.class,method="updateJkzj")
	void updateJkzj(String id,String zjid,String zjname,String zc);
	
	// 动态插入
	@SelectProvider(type=CjfwDaoImpl.class,method="updateJkzj1")
