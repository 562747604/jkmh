			...
			<div class="example-wrap">
				...
				>
					<input
						...
						onclick="doOut('d_yjfs')"
					/> <input
						id="b-edit"
						type="button"
						value="重发"
						class="btn btn-outline btn-default"
						style="margin-left:5px;<%=request.getAttribute("cfBtn")%>"
							onclick="doMsg('${ctx}/yxry/reFstj','fstj')"
					/>
				</div>
				<table
					width="100%"
				...
				>
					<tr>
						<td><i class="fa fa-table"></i> <lable class="pathtitle">健康专家
							>> 统计</lable></td>
					</tr>
					<tr>
						<td
 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							...
							onclick="doSx('${ctx}/sys/updateSearchColumn','fstj')"
						>
							<span
			...
			pageSize:10, //每页的记录行数（*）
			 ...
			 onColumnSwitch: 
				 ...
				 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
					var strColumns="";
					$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=fstj",arguments[0]);
		        },
		        queryParams: 
