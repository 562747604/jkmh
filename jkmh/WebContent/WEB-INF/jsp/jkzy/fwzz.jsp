 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							...
							onclick="doSx('${ctx}/sys/updateSearchColumn','fwzz')"
						>
							<span
			...
			pageSize:10, //每页的记录行数（*）
			 ...
			 onColumnSwitch: 
				 ...
				 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
					var strColumns="";
					$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=fwzz",arguments[0]);
		        },
		        queryParams: 
				...
				} ,
		        {
		            ...
		            formatter:function(value,row,index){  
		            		...
		            		if (row.fwzt=="待服务")
	            			{
		            			d="<a href=\"#\" mce_href=\"#\" onclick=\"showDiv('促进服务','${ctx}/jkzy/pgbg?id="+ row.id +"');\" style=\"<%=request.getAttribute("shBtn") %>\"><img title=\"审核\" src=\"${ctx}/images/update.gif\" /></a>";
	            			}
	            		else 
	            			{
	            			d="<a href=\"#\" mce_href=\"#\" onclick=\"showDiv('促进服务','${ctx}/jkzy/pgbg?id="+ row.id +"');\" style=\"<%=request.getAttribute("shBtn") %>\"><img title=\"服务\" src=\"${ctx}/images/top_home.gif\" /></a>";
	            			}
		            	return d;  
				   }
				}	, 
