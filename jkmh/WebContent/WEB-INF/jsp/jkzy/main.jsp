	...
	<div class="col-sm-12">
		<div class="example-wrap">
			<table width="100%" cellpadding="0" cellspacing="0" height="100%"
				...
				<tr><td colspan="3"><i class="fa fa-table"></i> <lable class="pathtitle">健康服务  >> 首页</lable></td></tr>
				<tr>
					<td>
						<div class="text-center" style="display: block;margin-top:10px;">
							<div class="m-r-md inline">
								<p>我的服务</p>
								<input type="text" value="<%=request.getAttribute("mysum") %>" class="dial m-r"
									data-hbval="<%=request.getAttribute("mysum") %>/<%=request.getAttribute("yhsum") %>" data-size="16" readonly="true" id="qu"
									name="qu" data-fgColor="#1AB394" data-max="<%=request.getAttribute("yhsum") %>"
					...
					<td>
						<div class="text-center" style="display: block;margin-top:10px;">
							<div class="m-r-md inline">
								<p>服务状态</p>
								<input type="text" value="<%=request.getAttribute("shsum") %>" class="dial m-r"
									data-hbval="<%=request.getAttribute("shsum") %>/<%=request.getAttribute("mysum") %>" data-size="16" readonly="true" id="qu"
									name="qu" data-fgColor="#1AB394" data-max="<%=request.getAttribute("mysum") %>"
									data-width="150" data-height="150" />
							</div>
						</div>
					</td>
