	...
	<div class="col-sm-12">
		<div class="example-wrap">
			<table width="100%" cellpadding="0" cellspacing="0" height="100%"
				...
				<tr><td colspan="3"><i class="fa fa-table"></i> <lable class="pathtitle">健康评估  >> 首页</lable></td></tr>
				<tr>
					<td>
						<div class="text-center" style="display: block;margin-top:10px;">
							<div class="m-r-md inline">
								<p>评估列表</p>
								<input type="text" value="763" class="dial m-r"
									data-hbval="763" data-size="16" readonly="true" id="qu"
									name="qu" data-fgColor="#1AB394" data-max="1000"
					...
					<td>
						<div class="text-center" style="display: block;margin-top:10px;">
							<div class="m-r-md inline">
								<p>重大阳性</p>
								<input type="text" value="778" class="dial m-r"
									data-hbval="778" data-size="16" readonly="true" id="qu"
									name="qu" data-fgColor="#1AB394" data-max="1000"
									data-width="100" data-height="100" />
							</div>
						</div>
	...
	<script type="text/javascript" charset="utf8">
		...
		$(function() {
			var t = echarts.init(document.getElementById("echarts-bar-chart")), n = {
				...
				legend : {
					data : [ "肝脏疾病", "脂肪肝", "超重", "高血压", "肥胖", "心脏病", "肺病" ]
				},
				grid : {
					x : 30,
					x2 : 40,
