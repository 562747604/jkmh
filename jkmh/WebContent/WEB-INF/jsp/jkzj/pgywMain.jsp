		...
		>
			<tr>
				...
				<!--  <input
					...
					value="加入复查"
					class="form-control"
					style="height:30px;width:80px;margin-left:20px;background-color: silver;cursor: default;"
			 		onclick="fc()" /> -->
				 <input
					type="button"
					value="审核通过"
					class="form-control"
					style="height:30px;width:80px;${shtg}"
					onclick="wc()"
				/>
				</td>
			</tr>
				...
				>
					...
					style="text-align:center;height:30px;line-height:30px; vertical-align:middle;width:200px;
					   ...
					   <tr>
							...
							><a href="${ctx}/jkzj/pgywMain?id=${rotate.previd}"><img
									src="${ctx}/images/jkpgyw/u756.png"
									style="height:30px;"
								></a> <img
								src="${ctx}/images/jkpgyw/u718.jpg"
								style="height:100px;"
							> <a href="${ctx}/jkzj/pgywMain?id=${rotate.nextid}"><img
                                    ...
                                    <div class="panel-heading" style="height:40px!important;">
                                        <div class="panel-options" style="height:40px!important;">
                                            <ul class="nav nav-tabs"style="height:40px!important;"  >
                                                <li  id="tl1" class="active" style="height:40px!important;"> <a onclick="showsrc('${ctx}/jkzj/pgywMain1?id=${rotate.id}','tl1');return false"
								href="javascript:void(0)"  style="height:40px!important;"  ><h2 style="margin-top: 0px;margin-bottom: 0px;">评估结论</h2></a>
                                                </li>
                                                <li id="tl2" class="" style="height:40px!important;"><a onclick="showsrc('${ctx}/jkzj/pgywMain2?id=${rotate.id}','tl2');return false"
								href="javascript:void(0)"   style="height:40px!important;"  ><h2 style="margin-top: 0px;margin-bottom: 0px;">重要指标</h2></a>
                                                </li>
												<li id="tl3" style="height:40px!important;">
												<a  onclick="showsrc('${ctx}/jkzj/pgywMain3?id=${rotate.id}','tl3');return false"
								href="javascript:void(0)"   style="height:40px!important;" target="ifc" ><h2 style="margin-top: 0px;margin-bottom: 0px;">慢病风险</h2></a>
							                    </li>
												<li id="tl4" style="height:40px!important;">
												<a onclick="showsrc('${ctx}/jkzj/pgywMain4?id=${rotate.id}','tl4');return false"
								href="javascript:void(0)"   style="height:40px!important;" target="ifc"><h2 style="margin-top: 0px;margin-bottom: 0px;">健康指导</h2></a>
							                    </li>
<!-- 												<li style="height:40px!important;"> -->
<!-- 												<a href="${ctx}/jkzj/pgywMain5?id=${rotate.id}" style="height:40px!important;"><h2 style="margin-top: 0px;margin-bottom: 0px;">促进目标</h2></a> -->
<!-- 							                    </li> -->
                                            </ul>
                                        </div>
                                    </div>
					...
					<table style="width:100%;text-align:center;">
                     ...
                     <iframe
						...
						src="${ctx}/jkzj/pgywMain1?id=${rotate.id}"
					></iframe>
				</td>
			</tr>
		</table>
	  ...
	  $("#ifc").attr("src",o);
		...
		function wc(){
			...
			$.ajax({
                ...
                type: "get",
                dataType: "Json",
                url: "${ctx}/jkzj/reviewHealthManual",
                data: {
                    id: "${rotate.id}",
                    time: Math.random()
                },
                success: function (data)
                {
                	...
                	swal({
                		...
                		parent.gb();
                		$(window.parent.parent.$("#iframe0"))[0].contentWindow.sx1();
                	});
