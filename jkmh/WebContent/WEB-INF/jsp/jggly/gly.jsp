				...
				<div class="example">
					...
					>
						...
						/> <input
							...
							onclick="del('${ctx}/jggly/deletGly','Gly')"
						/>
					</div>
					<table
						id="rsTab"
 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							type="button"
							class="btn btn-primary"
							onclick="doSx('${ctx}/sys/updateSearchColumn','glygl')"
						>
							<span
								class="glyphicon glyphicon-floppy-disk"
								aria-hidden="true"
	...
	function load(){
			...
			pageSize : 10, //每页的记录行数（*）
			 ...
			 onColumnSwitch: 
				 ...
				 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
					var strColumns="";
					$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=glygl",arguments[0]);
		        },
		        queryParams: 
		...
		function doAdd() {//新增保存方法
			...
			}else if(document.getElementById("a_csrq").value==""){
