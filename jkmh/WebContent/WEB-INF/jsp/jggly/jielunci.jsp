				...
				<div class="example">
					...
					>
						...
						/> <input
							...
							onclick="del('${ctx}/jggly/deleteJielunci','jielunci')"
						/>
					</div>
					<table
						id="rsTab"
 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							type="button"
							class="btn btn-primary"
							onclick="doSx('${ctx}/sys/updateSearchColumn','jlc')"
						>
							<span
								class="glyphicon glyphicon-floppy-disk"
								aria-hidden="true"
		...
		pageSize:10, //每页的记录行数（*）
		 ...
		 onColumnSwitch: 
			 ...
			 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
				var strColumns="";
				$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=jlc",arguments[0]);
	        },
	        queryParams: 
	...
	function edit(id) {//修改按钮方法
		...
		$.ajax({
           ...
           success: function (data)
           {
               ...
               document.getElementById("e_bz").value = t.rows[0]["bz"];
   			$('#editModel').modal();
           }
       });
	}
