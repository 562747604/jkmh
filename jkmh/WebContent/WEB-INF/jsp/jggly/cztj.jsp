				...
				<div class="example">
					...
					>
						<input
							...
							value="充值"
							class="btn btn-outline btn-default"
							style="<%=request.getAttribute("czBtn") %>"
							onclick="showDiv('短信充值','${ctx}/jggly/cz')"
						/>
					</div>
					<table
						id="rsTab"
 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							...
							onclick="doSx('${ctx}/sys/updateSearchColumn','cztj')"
						>
							<span
			...
			pageSize:10, //每页的记录行数（*）
			 ...
			 onColumnSwitch: 
				 ...
				 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
					var strColumns="";
					$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=cztj",arguments[0]);
		        },
		        queryParams: 
