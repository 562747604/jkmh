 ...
 %>
					...
					<div class="modal-footer">
						...
						<button
							...
							onclick="doSx('${ctx}/sys/updateSearchColumn','rzgl')"
						>
							<span
			...
			pageSize:10, //每页的记录行数（*）
			 ...
			 onColumnSwitch: 
				 ...
				 var vc= $('#exampleTableEvents').bootstrapTable('getVisibleColumns','');			
					var strColumns="";
					$.post("${ctx}/sys/updateToggleColumn?clickColumn="+arguments[0]+":"+arguments[1]+"&tblname=rzgl",arguments[0]);
		        },
		        queryParams: 
